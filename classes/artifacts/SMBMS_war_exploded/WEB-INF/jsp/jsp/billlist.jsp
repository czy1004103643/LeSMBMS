<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@include file="/WEB-INF/jsp/jsp/common/head.jsp"%>
...
<div class="right">
       ...
       <div class="search">
       <form method="get" action="${pageContext.request.contextPath }/bill.html">
			...
			<select name="queryIsPayment">
			 ...
			 <a href="${pageContext.request.contextPath }/WEB-INF/jsp/jsp/billadd.jsp">添加订单</a>
		</form>
       </div>
       <!--账单表格 样式和供应商公用-->
...
<%@include file="/WEB-INF/jsp/jsp/common/foot.jsp" %>
